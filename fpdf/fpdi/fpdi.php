...
class FPDI extends FPDF_TPL
{
    ...
    /*============================================
        Print Type of user economic activity
    ==============================================*/
        public function circle_activity($databaseType, $type, $paramX, $paramY){
            if( $databaseType == $type ){
                $this->SetXY($paramX, $paramY);
                $this->SetFont('DejaVu', '', 23);
                $this->Cell(40,12,"0",0,2);
            }
        }
}